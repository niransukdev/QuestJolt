 ...
 * This file demonstrates how to integrate Questjolt with a web frontend
 */

// For React/Vue/Angular applications
export class QuestjoltClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuestjoltClient(provider, contractAddress);
